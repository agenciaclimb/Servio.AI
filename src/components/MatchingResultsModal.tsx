...
const MatchingResultsModal: React.FC<MatchingResultsModalProps> = ({ results, onClose, onInvite }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog" onClick={onClose}>
            <div className="bg-slate-50 rounded-2xl shadow-xl w-full max-w-4xl m-4 transform transition-all h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
                <header className="relative p-6 border-b border-gray-200">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Encontramos os melhores profissionais para o seu serviço. Você pode convidá-los para enviar uma proposta.</p>
                </header>
