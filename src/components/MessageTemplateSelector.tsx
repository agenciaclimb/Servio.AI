  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">📝 Templates de Mensagens</h2>
      ...
      <div className="space-y-4">
        {filteredTemplates.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            <p className="text-gray-500 text-lg">Nenhum template encontrado com esses filtros</p>
            <button
              onClick={() => {
          ...
          filteredTemplates.map(template => {
            ...
            return (
              ...
              >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-2xl">
                        {template.emoji || platformIcons[template.platform]}
                      </span>
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      {template.bestTime && (
                        <span className="text-gray-500">⏰ {template.bestTime}</span>
                      )}
                    </div>
                  </div>
                ...
                {!isExpanded && (
                  <div className="mb-3">
                    <p className="text-gray-700 line-clamp-3 whitespace-pre-wrap">{formatted}</p>
                  </div>
                )}
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">💡 Dicas para Compartilhar</h3>
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <span>
              <strong>Personalize:</strong> Adicione seu toque pessoal à mensagem antes de
              compartilhar
            </span>
          </li>
          <li className="flex items-start gap-2">
