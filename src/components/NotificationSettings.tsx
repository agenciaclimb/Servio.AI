...
type NotificationSetting = {
  id: 'job_updates' | 'proposal_updates' | 'payment_updates' | 'message_updates' | 'follow_up_reminders';
  label: string;
  description: string;
  icon: string;
};
  ...
  return (
    <div className="bg-white shadow sm:rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">Configurações de Notificação</h3>
