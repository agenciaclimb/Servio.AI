...
const ServiceCatalogModal: React.FC<ServiceCatalogModalProps> = ({ user, onClose, onSave }) => {
  ...
  const [newServiceType, setNewServiceType] = useState<
    'tabelado' | 'personalizado' | 'diagnostico'
  >('personalizado');
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl m-4 transform transition-all max-h-[90vh] flex flex-col"
      ...
      >
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <select
                ...
                onChange={e =>
                  setNewServiceType(e.target.value as 'personalizado' | 'tabelado' | 'diagnostico')
                }
                className="block w-full rounded-md border-gray-300 dark:bg-gray-900 dark:border-gray-600 shadow-sm"
              >
        ...
        <div className="bg-gray-50 dark:bg-gray-900 px-8 py-4 rounded-b-2xl text-right flex-shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="mr-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600"
          >
            Cancelar
          </button>
          <button
