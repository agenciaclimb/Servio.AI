      ...
      case 'upload':
        return (
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 text-sm">Por favor, envie uma foto nítida da frente do seu RG ou CNH.</p>
      ...
      case 'review':
        return (
          <div>
            ...
            <p className="mt-2 text-gray-600 text-sm text-center">Nossa IA extraiu estas informações. Por favor, verifique se estão corretas.</p>
