  ...
  return (
    ...
    >
      <div
        ...
        className="bg-slate-50 rounded-2xl shadow-xl w-full max-w-3xl m-4 transform transition-all h-[90vh] flex flex-col"
      >
        <header className="relative p-6 border-b border-gray-200">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            Propostas para: <span className="text-blue-600">{job.category}</span>
          </h2>
          ...
          {proposals.filter(p => p.status !== 'bloqueada').length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Aguarde um pouco. Os prestadores foram notificados sobre seu job.
              </p>
            </div>
          )}
        </main>
