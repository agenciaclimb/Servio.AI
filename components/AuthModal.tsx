...
const AuthModal: React.FC<AuthModalProps> = ({ mode, userType, onClose, onSwitchMode, onSuccess }) => {
  ...
  return (
    <div {...getModalOverlayProps(onClose)} className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center" data-testid="auth-modal">
      <div {...getModalContentProps()} className="bg-white rounded-2xl shadow-xl w-full max-w-md m-4 transform transition-all">
