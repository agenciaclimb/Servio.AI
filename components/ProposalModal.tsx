      ...
      >
        <div className="relative p-8">
          ...
          <p className="text-gray-600 mb-4">
            Para o job: <span className="font-semibold text-gray-700">{job.category}</span>
          </p>
 ...
 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"
            ...
            <div className="text-center mt-4 p-2 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-xs text-yellow-800">
                <span className="font-bold">Dica de Segurança:</span> Mantenha todas as negociações
                e pagamentos dentro da SERVIO.AI para garantir sua proteção.
              </p>
            </div>
          </form>
        </div>
