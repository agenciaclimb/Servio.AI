...
const ProfileModal: React.FC<ProfileModalProps> = ({ user, onClose, onSave }) => {
  ...
  const [hasCriminalRecordCheck, setHasCriminalRecordCheck] = useState(
    user.hasCriminalRecordCheck || false
  );
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-2xl shadow-xl w-full max-w-2xl my-4 sm:my-auto transform transition-all flex flex-col"
        ...
        >
          <div className="relative p-4 sm:p-6 flex-grow overflow-y-auto">
            ...
            {user.type === 'prestador' && (
              <div className="mb-4">
                ...
                {enhanceError && (
                  <p className="text-xs text-red-600 mt-2 text-center">{enhanceError}</p>
                )}
              </div>
            )}
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                      placeholder="Ex: Eletricista Profissional"
                    />
                  </div>
                  <div>
                    <label
                    ...
                    <input
                      ...
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                      placeholder="Ex: Instalação, Reparo de curto-circuito, Manutenção"
                    />
                  </div>
                </>
              )}
                ...
                <>
                    ...
                    <div className="mt-4 p-4 border border-gray-200 rounded-lg bg-slate-50 space-y-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="block w-full text-sm p-2 border-gray-300 rounded-md"
                        />
                      </div>
                      <div>
                        <label htmlFor="portfolio-desc" className="sr-only">
                      ...
                      <div>
                        <label htmlFor="portfolio-image-upload" className="sr-only">
                          Imagem do Projeto
                        </label>
                        <input
                          type="file"
                          ...
                          accept="image/*"
                          onChange={e =>
                            setNewPortfolioImage(e.target.files ? e.target.files[0] : null)
                          }
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Aumente a confiança dos clientes (simulação).
                    </p>
                    <div className="space-y-2">
                      <div className="relative flex items-start">
                        ...
                        <div className="ml-3 text-sm leading-6">
                          <label htmlFor="certificates" className="font-medium text-gray-900">
                            Possuo certificados e diplomas
                          </label>
                          <p className="text-gray-600">
                            Marque se você pode fornecer comprovantes de suas qualificações.
                          </p>
                        </div>
                      </div>
                      <div className="relative flex items-start">
                        <div className="flex h-6 items-center">
                          <input
                            ...
                            name="criminal"
                            type="checkbox"
                            checked={hasCriminalRecordCheck}
                            onChange={e => setHasCriminalRecordCheck(e.target.checked)}
                            className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600"
                          />
                        </div>
                        <div className="ml-3 text-sm leading-6">
                          <label htmlFor="criminal" className="font-medium text-gray-900">
                            Verificação de antecedentes
                          </label>
                          <p className="text-gray-600">
                            Marque se você pode fornecer um atestado de antecedentes criminais.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="bg-gray-50 px-4 sm:px-6 py-3 rounded-b-2xl text-right flex-shrink-0 border-t border-gray-200">
            <button
              type="button"
              onClick={onClose}
              className="mr-2 px-3 sm:px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50"
            >
              Cancelar
            </button>
            <button
              type="submit"
              className="px-3 sm:px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700"
            >
              Salvar Alterações
            </button>
          </div>
