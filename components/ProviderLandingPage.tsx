...
const FeatureCard: React.FC<{ icon: string; title: string; children: React.ReactNode }> = ({
  icon,
  title,
  children,
}) => (
...
const StepCard: React.FC<{ number: string; title: string; children: React.ReactNode }> = ({
  number,
  title,
  children,
}) => (
    ...
    <div className="bg-white">
      ...
      <section className="text-center py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 rounded-lg">
        ...
        <p className="mt-4 max-w-md mx-auto text-lg text-gray-600 sm:text-xl md:mt-5 md:max-w-3xl">
          Conectamos seu talento a milhares de clientes que precisam de você. Foque no que você faz
          de melhor, e deixe que a SERVIO.AI cuide do resto.
        </p>
        <div className="mt-8">
          <button
      ...
      <section className="py-20">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
          <StepCard number="1" title="Crie seu Perfil Grátis">
            Mostre suas habilidades, adicione sua localização e deixe nossa IA otimizar seu perfil
            para atrair os clientes certos.
          </StepCard>
          <StepCard number="2" title="Receba Oportunidades">
            Seja notificado sobre novos serviços na sua área de atuação. Escolha os jobs que mais te
            interessam.
          </StepCard>
          <StepCard number="3" title="Realize o Serviço e Receba">
            Envie sua proposta, realize o trabalho e receba seu pagamento de forma segura através da
            nossa plataforma.
          </StepCard>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50 rounded-lg">
        ...
        <div className="mt-12 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <FeatureCard icon="🎯" title="Clientes Qualificados">
            Chega de perder tempo. Conectamos você a clientes que realmente precisam dos seus
            serviços e estão prontos para contratar.
          </FeatureCard>
          <FeatureCard icon="🔒" title="Pagamento Seguro e Garantido">
            Com nosso sistema de custódia, o pagamento do cliente fica retido e é liberado para você
            assim que o serviço é concluído. Mais segurança e zero calote.
          </FeatureCard>
          <FeatureCard icon="✨" title="Perfil Otimizado por IA">
            Nossa inteligência artificial ajuda a criar um perfil campeão, destacando seus pontos
            fortes para que você seja encontrado mais facilmente.
          </FeatureCard>
          <FeatureCard icon=" calendar-alt" title="Flexibilidade Total">
            Você está no controle. Defina seus próprios horários, escolha os serviços que quer
            atender e trabalhe de onde estiver.
          </FeatureCard>
        </div>
      </section>
        ...
        <div className="mt-12 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
            <p className="text-gray-600 italic">
              "Desde que entrei na SERVIO.AI, minha agenda está sempre cheia. A plataforma realmente
              me conecta com clientes sérios e organizados. O pagamento seguro é um diferencial
              enorme."
            </p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
            <p className="text-gray-600 italic">
              "A ferramenta de IA para criar propostas me economiza muito tempo. Consigo enviar
              orçamentos personalizados em segundos. Recomendo para todos os colegas de profissão."
            </p>
      ...
      <section className="py-20 bg-blue-600 text-white text-center rounded-lg">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-blue-100">
          Junte-se a centenas de profissionais que já estão crescendo com a SERVIO.AI. O cadastro é
          rápido, gratuito e abre um mundo de oportunidades.
        </p>
        <div className="mt-8">
          <button
            onClick={onRegisterClick}
