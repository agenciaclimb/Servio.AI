  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center bg-white p-10 rounded-2xl shadow-xl border border-gray-100 max-w-lg">
        ...
        <p className="text-gray-600 mt-2">Seu pagamento foi processado com sucesso. O profissional foi notificado e você pode acompanhar o andamento do serviço no seu painel.</p>
        <p className="text-sm text-gray-500 mt-4">ID da Sessão: {searchParams.get('session_id') || '—'}</p>
        <button
