...
const JobLocationModal: React.FC<JobLocationModalProps> = ({
  job: _job,
  client,
  provider,
  onClose,
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-2xl shadow-xl w-full max-w-2xl m-4 transform transition-all"
      >
        <header className="relative p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Visão geral da rota entre o cliente e o prestador.
          </p>
        </header>
        ...
        <main className="p-6">
          ...
          <div className="mt-4 text-center bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            <p className="text-xs text-yellow-800">
              <span className="font-bold">Aviso de Privacidade:</span> As localizações no mapa são
              aproximadas para proteger a privacidade. O endereço exato do serviço está disponível
              no chat.
            </p>
          </div>
        </main>
