...
const AdminVerificationCard: React.FC<AdminVerificationCardProps> = ({
  provider,
  onApprove,
  onReject,
}) => {
    ...
    <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
      <div className="p-5">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
          ...
          <span className="mt-2 sm:mt-0 text-xs font-semibold px-2 py-1 rounded-full bg-yellow-100 text-yellow-800">
            Pendente
          </span>
        </div>
