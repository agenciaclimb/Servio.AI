...
const ProspectingNotificationModal: React.FC<ProspectingNotificationModalProps> = ({
  prospects,
  onClose,
}) => {
  return (
      ...
      >
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mt-2">
            Não encontramos um profissional 100% compatível em sua área no momento, mas não se
            preocupe!
          </p>
          <p className="text-gray-600 mt-1">
            Nossa equipe foi notificada e já está buscando ativamente os melhores talentos para o
            seu serviço. Entraremos em contato em breve.
          </p>
          <div className="mt-6 text-left text-xs bg-gray-50 p-3 rounded-lg border">
            <p className="font-semibold text-gray-600">
              A IA sugeriu os seguintes perfis para nossa equipe de prospecção:
            </p>
