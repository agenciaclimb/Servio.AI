...
**Fonte:** gemini  
**Prioridade:** 🟠 HIGH  
**Labels sugeridas:** orchestrator, gemini, task, backend, api, marketplace-matching

---

## 🎯 Título da Task

Backend: Criar Endpoint da API para Iniciar o 'Marketplace Matching'
...
Desenvolver um novo endpoint POST em `backend/src/routes/jobs.js` no formato `/api/v2/jobs/{jobId}/trigger-matching`. Este endpoint deve: 1. Validar se o 'jobId' existe. 2. Alterar o 'matching_status' do job para 'in_progress'. 3. Retornar uma resposta de sucesso { 'status': 'matching_started' }. A lógica de matching real não será implementada nesta task.

---

## ✅ Critérios de Aceitação (para o PR)

- ✅ A implementação deve focar **APENAS** nesta task (2.2), sem misturar com outras
...
> **"Copilot, implemente a Task 2.2 descrita neste arquivo.**  
