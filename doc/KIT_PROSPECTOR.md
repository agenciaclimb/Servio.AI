# 📋 Kit de Material do Prospector Servio.AI
...
✅ Clientes da sua região que precisam do seu serviço te encontram
✅ Você recebe as propostas direto no seu celular
✅ Fecha o serviço e cobra do cliente
✅ Paga apenas uma pequena comissão pelo match (15% do valor)

ZERO mensalidade, ZERO custo fixo. Você só paga se trabalhar.

Além disso:
- Você controla sua agenda
- Define seus próprios preços
- Recebe avaliações que aumentam sua credibilidade
- Tem suporte 7 dias por semana

Quer entrar? Vou te mandar o link com um código especial de cadastro.
```
...
Você é eletricista, encanador, pintor, faxineiro(a), marceneiro ou outro profissional?

A Servio.AI está conectando profissionais qualificados com clientes em [sua cidade].

Como funciona:
✅ Cadastro 100% GRATUITO
✅ Você define seus preços
✅ Recebe propostas no WhatsApp
✅ Paga comissão só quando fechar serviço
✅ Sem mensalidade, sem taxa de cadastro

📱 Crie seu perfil agora: [seu link personalizado]
...
✅ Pagamento fica retido até você finalizar o serviço
✅ Se tiver problema, tem mediação (tipo um juiz digital)
✅ Você só aceita os serviços que quiser
✅ Pode avaliar o cliente também

Além disso, já tem [X] prestadores usando e a nota média é [Y] estrelas.
...
- ✅ Suporte 7 dias (se der problema, tem quem ajudar)
...
- "Avaliação média da plataforma: [X] estrelas"
- "Tempo médio de resposta: [X] minutos"
...
- Coworkings e espaços de negócios
...
- [ ] Postar em 2 grupos/redes sociais diferentes
...
- **Seu Link Personalizado**: `https://servio-ai.com?invite=[seu-codigo]`
- **Dashboard**: `https://servio-ai.com/dashboard/prospector`
- **Suporte**: suporte@servio-ai.com
- **WhatsApp Suporte**: (XX) XXXX-XXXX

---

## 💡 Dicas Finais

1. **Seja autêntico**: Pessoas confiam em pessoas, não em robôs
2. **Foque em ajudar**: Seu objetivo é resolver o problema deles, não só ganhar comissão
3. **Acompanhe números**: Use o dashboard para saber o que funciona
4. **Peça feedback**: Pergunte aos prestadores o que acham
5. **Celebre vitórias**: Cada cadastro é um passo para sua meta
