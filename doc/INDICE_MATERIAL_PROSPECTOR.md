# 📚 Material do Prospector - Índice Completo

Bem-vindo ao centro de recursos para prospectores Servio.AI! Este índice organiza todos os materiais disponíveis para você ter sucesso.
...
- Onde encontrar prestadores (online e offline)
- Como abordar (regra de ouro + mensagens base)
- Processo completo de cadastro passo a passo
- Explicação do dashboard e sistema de badges
...
- Argumentos com dados e números
...
- ✅ Descobrir novos canais

**Tempo de leitura:** ~20 minutos (mas use como referência contínua)
...
- **6 Templates Completos:**
  ...
  3. Follow-up após 48h
  4. E-mail com Prova Social
  5. Para Quem Já Demonstrou Interesse
  6. E-mail de Reengajamento (7 dias)
- Dicas de personalização
- Timing ideal (dia e horário)
- Linhas de assunto que funcionam (e quais evitar)
...
4. Revise materiais semanalmente
...
**Foco:** Consistência. Meta: 5 contatos/dia.
...
**Foco:** Otimização. Meta: 3 cadastros/semana.
...
**Foco:** Escala e automação. Meta: 5+ cadastros/semana.
...
**Sugestões?** Envie para: suporte@servio-ai.com
...
- [ ] Li o GUIA_RAPIDO_PROSPECTOR.md completo
- [ ] Salvei os 3 scripts do KIT_PROSPECTOR.md no meu celular
- [ ] Personalizei pelo menos 2 templates de e-mail
- [ ] Pratiquei resposta para as 5 objeções principais
- [ ] Tenho este índice salvo para consulta rápida
- [ ] Sei onde buscar cada tipo de informação

---

## 🚀 Próximos Passos

Agora que você conhece os materiais disponíveis:

1. **Defina sua meta desta semana** (ex: 3 cadastros)
2. **Escolha 1 canal para começar** (ex: Instagram)
3. **Faça seu primeiro contato hoje** (não espere estar 100% pronto)
4. **Consulte os materiais conforme precisar**
5. **Ajuste com base nos resultados**

**Lembre-se:** Ação imperfeita > Preparação perfeita
