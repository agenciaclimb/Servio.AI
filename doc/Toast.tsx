...
const Toast: React.FC<ToastProps> = ({ message, removeToast }) => {
  ...
  return (
    <div
      className={`w-full max-w-sm bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden transform transition-all animate-fade-in-right ${toastStyles[type]}`}
    >
      <div className="p-4">
