# 🚀 Guia Rápido do Prospector Servio.AI

## Bem-vindo!

Este guia vai te ensinar tudo que você precisa para começar a recrutar prestadores e ganhar comissões. Leia com atenção e consulte sempre que precisar.

---

## 📌 O Que É um Prospector?

Você é um **embaixador da marca** Servio.AI. Seu trabalho é:

1. Encontrar prestadores de serviço qualificados
2. Explicar como a plataforma funciona
3. Ajudá-los a criar perfil
4. Ganhar comissão pelos serviços que eles fecharem
...
- Você ganha 1% de TUDO que ele faturar na plataforma
- **Para sempre!**
...
- Você ganha 0.25% de tudo que ele faturar
- **Para sempre!**
...
**Total em 3 meses: R$ 190**

Se você recrutar 20 prestadores ativos como João:
**R$ 190 × 20 = R$ 3.800/mês em comissões recorrentes!**
...
- [ ] **Acesse seu dashboard**: [URL do dashboard]
- [ ] **Anote seu código de convite**: Você vai usá-lo MUITO
- [ ] **Configure suas metas**: Quantos prestadores quer recrutar por semana?
- [ ] **Baixe os materiais**: Kit de prospecção, templates de e-mail, scripts
...
**Sempre use este link!** É assim que rastreamos suas indicações.
...
1. **Instagram Local**
   ...
   - Envie DM com script do kit

2. **Grupos de Facebook**
   - "Serviços [sua cidade]"
   - "Profissionais autônomos [região]"
   - Seja útil, não faça spam

3. **LinkedIn**
   - Busque por "prestador de serviço", "autônomo"
   - Conecte + mensagem personalizada

4. **Google Meu Negócio**
   - Busque "encanador [cidade]"
   - Veja quem tem perfil
   - Entre em contato
...
2. **Feiras e eventos**
   - Feiras de casa e construção
   - Eventos de empreendedorismo

3. **Boca a boca**
   - Seu encanador, eletricista, etc
   - Amigos que prestam serviço
...
## 🛠️ Processo de Cadastro (Passo a Passo)
...
- 💎 **Platina**: 25-49 recrutados
- 👑 **Diamante**: 50+ recrutados

Cada badge desbloqueia **benefícios extras**!
...
**Mais objeções?** [EMAIL_TEMPLATES_PROSPECTOR.md]
...
- Meta de comissão: R$ 1.500-3.000
...
4. "Quando recebo pagamento?" → Todo dia 5 do mês seguinte

---

## 🏆 Dicas de Quem Já Fez

### Top Prospectores Dizem:

**Maria (127 recrutados):**
"Foco em ajudar de verdade. Quando você ajuda o prestador a ter sucesso, sua comissão vem naturalmente."

**Carlos (89 recrutados):**
"Linkedin foi meu canal de ouro. Pessoas lá são mais profissionais e sérias."

**Ana (76 recrutados):**
"Grupos de WhatsApp da minha cidade. Entrei em 10 grupos de 'serviços e reformas' e recruto 2-3 por semana."

---

## ✅ Checklist Diária do Prospector

- [ ] Abrir dashboard (ver novas comissões motiva!)
- [ ] Fazer 5 novos contatos
- [ ] Fazer follow-up de 3 contatos anteriores
- [ ] Responder dúvidas de prestadores recrutados
- [ ] Postar conteúdo em 1 rede social
- [ ] Ajudar 1 prestador a completar perfil

**15-30 minutos por dia = resultados consistentes**

---

## 🎯 Resumo em 10 Pontos

1. ✅ Você ganha comissão recorrente de prestadores que recrutar
2. ✅ Use sempre seu link/código personalizado
3. ✅ Foque no benefício DELES, não na sua comissão
4. ✅ Ajude no cadastro (aumenta conversão)
5. ✅ Acompanhe diariamente seu dashboard
6. ✅ Faça follow-up (maioria fecha no 2º ou 3º contato)
7. ✅ Teste vários canais, otimize o que funciona
8. ✅ Seja autêntico, não robótico
9. ✅ Meta: 3 cadastros por semana
...
Não espere estar "pronto". Você aprende fazendo.

**Primeira ação:** Mande mensagem para 1 prestador que você conhece nos próximos 5 minutos.
