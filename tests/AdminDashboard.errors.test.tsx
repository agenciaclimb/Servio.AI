...
vi.mock('../components/AdminJobManagement', () => ({ default: ({ onMediateClick }: any) => <div data-testid="job-mgmt"><button onClick={()=> onMediateClick({ id:'job123', clientId:'cli@ex.com', providerId:'prov@ex.com' })}>Mediate</button></div> }));
