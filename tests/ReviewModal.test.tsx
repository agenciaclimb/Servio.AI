...
describe('ReviewModal', () => {
  ...
  it('renderiza modal com título e campos', () => {
    ...
    expect(screen.getByRole('button', { name: /Liberar Pagamento e Enviar Avaliação/i })).toBeInTheDocument();
  });
  ...
  it('gera comentário com IA quando botão é clicado', async () => {
    ...
    expect(geminiService.generateReviewComment).toHaveBeenCalledWith(5, 'Pintura', 'Pintar parede da sala');
  });
