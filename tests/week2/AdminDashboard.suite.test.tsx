...
describe('AdminDashboard', () => {
  ...
  describe('Navigation', () => {
    it('should have analytics section', () => {
      ...
      const analyticsLink = Array.from(screen.queryAllByRole('button', { hidden: true }))
        .find(btn => /analytics|estatísticas|gráfico/i.test(btn.textContent || ''))
    ...
    it('should have moderation section', () => {
      ...
      const moderationLink = Array.from(screen.queryAllByRole('button', { hidden: true }))
        .find(btn => /moderation|moderação|análise/i.test(btn.textContent || ''))
    ...
    it('should have users management section', () => {
      ...
      const usersLink = Array.from(screen.queryAllByRole('button', { hidden: true }))
        .find(btn => /users|usuários|clientes/i.test(btn.textContent || ''))
    ...
    it('should have jobs management section', () => {
      ...
      const jobsLink = Array.from(screen.queryAllByRole('button', { hidden: true }))
        .find(btn => /jobs|trabalhos|serviços/i.test(btn.textContent || ''))
  ...
  describe('Data Loading', () => {
    it('should load and display data on mount', () => {
      ...
      const dashboard = screen.getByTestId('analytics') || 
